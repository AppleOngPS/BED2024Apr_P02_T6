...
const booksController = require("../practicals/PolytechnicLibraryAPI/controllers/booksController");
const Book = require("../practicals/PolytechnicLibraryAPI/models/user");



// Mock the Book model
jest.mock("../practicals/PolytechnicLibraryAPI/models/Book"); // Replace with the actual path to your Book model
